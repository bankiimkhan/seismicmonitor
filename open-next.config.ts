...
// shared 15-minute window over the USGS/NCS feeds. With no incremental cache
// configured that revalidate hint is silently dropped and every request
// re-fetches upstream -- slower, and needlessly rude to two public feeds.
//
